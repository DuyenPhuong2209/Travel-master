...
<div class="container mt-5">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item subnav">
            <a class="nav-link active package" href="#">Tour</a>
        </li>
        <li class="nav-item subnav">
            <a class="nav-link reviews" href="#">Nhận xét</a>
        </li>
        <li class="nav-item subnav">
            <a class="nav-link info" href="#">Thông tin</a>
        </li>
    </ul>
</div>
...
<div class="lead container package-content">
    ...
    <div class="container ml-5">
        <form action="search_agency_package.php?agency_id=<?php echo $agency_id; ?>" method="post" class="input-group ml-3 mt-5 float-center">
            <input type="text" name="search" id="" placeholder="Tìm kiếm tour" class="form-control col-md-4" style="border-top-right-radius: 3px;  border-bottom-right-radius: 3px;"> 
            <button class="btn btn-outline-success ml-1 p-2" type="submit" name="Tìm kiếm"><i class="fas fa-search"></i></button>
        </form>
    </div>
                    ...
                    <div class="col-md-8">
                        <div class="card-body pt-0">
                            ...
                            <?php 
                                ...
                                if(!empty($date) && $date['status'] == 'Kết thúc'){
                                    echo '<span class="badge rounded-pill ml-1 status">'. ucwords($date['status']) .'</span>';
                                }
                            ?>
                            </h4>
                            <h5 class="font-italic text-info" style="font-size: .85rem;"><span class="mr-1"><i class="fas fa-map-marker-alt"></i></span><?php echo $package['location'] ; ?></h5>
                            <div class="" style="font-size: .85rem;">
                                <p class="text-muted pt-2"><span class="mr-1" ><i class="far fa-clock"></i></span><?php echo $package['num_days'] .' ngày '. $package['num_nights'] .' đêm' ?></p>
                            </div>
                            <p class="card-text mb-3" style="font-size: .7rem;"><?php echo substr($package['place_details'], 0, 40); ?>...</p><hr>

                            <div>
                                <p class="text-muted" >
                                    <h5> <?php echo number_format($package['budget_price'], 0 , $c = "," , $d = "." )."VND" ?></h5>
                                    <a href="package.php?package_id=<?php echo $package['package_id']; ?>" class="btn btn-primary float-right" style="position: relative; top: -30px; font-size: .8rem;">Xem chi tiết<span class=" ml-2"><i class="fas fa-angle-right"></i></span>
                                    </a>
                                </p>
                            </div>
                        </div>
...
<div class="container review-content">
    <h5 class="mt-5 pl-3">Xếp hạng & Nhận xét (<?php echo $total_person = $stmt->rowCount(); ?>)</h5>
                            ...
                            <div class="rating-bar0 justify-content-center">
                                <table class="text-left mx-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td class="rating-bar">
                                            <div class="progress rounded-pill">
                                                <div class="progress-bar bg-danger" role="progressbar" style="width: <?php echo round(($rate1 / $total_person) * 100) ?>%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </td>
        ...
        <div class="row">
                ...
                <div class="card effect">
                    <div class="row d-flex">
                        ...
                        <div class="d-flex flex-column">
                            <h3 class="mt-2 mb-0"><?php echo ucwords($tourist['tourist_name']); ?></h3>
                            <div>
                    ...
                    <div class="row text-left">
                        <!-- <h4 class="mt-3">"Một nơi tuyệt vời để trải nghiệm du lịch"</h4> -->
            ...
            <?php
                if(isset($_POST['post_review'])){
                    ...
                    if(empty($rate)){
                        $_SESSION['error'] = "Xếp hạng không thể là không";
                    ...
                    if(!empty($count)){
                        ...
                        $stmt = $pdo->prepare('INSERT INTO reviews(agency_id, tourist_id, rating, comment, review_status, review_date)
                         VALUES(:agency_id, :tourist_id, :rating, :comment, :review_status, :review_date)');
            ...
            <div class="col-sm-4 mt-4"  style="font-size: .9rem">
                ...
                <div class="form-group">
                    <form action="" method="post">
                        <label for="">Xếp hạng trải nghiệm của bạn</label>
                        <div> 
                        ...
                        <div class="form-group">
                            <label for="">Viết bình luận (tùy chọn)</label><br>
                            <textarea name="comment" id="body" cols="50" rows="10"></textarea>
                        </div>
                        <?php
                            if(isset($_SESSION['tourist_id'])  && (!empty($payment) && $payment['tour_status'] == 'Hoàn thành')){
                                echo '<div class="form-group">
                                        <input type="submit" class="btn btn-primary formPost" name="post_review" value="Gửi">
                                    </div>';
                            }
                        ?>
...
<div class="lead container info-content">
    <h5 class="mt-5 pl-3">Thông tin đại lý</h5>
    <div class="row">
        <div class="col-sm-8">
            <div class="card pb-0" style="border: none;">
                <div class="card-body">
                    <div class="py-3">
                        <span class="font-weight-bold font-italic border-bottom border-dark">Chủ sở hữu</span>
                    </div>
                    <div class="py-2 pl-2">
                        <span class="font-weight-bold mr-2">Tên:</span><?php echo $agency['owner_name']; ?>
                    </div>
                    <div class="py-2 pl-2">
                    ...
                    <div class="py-2 pl-2">
                        ...
                        <span class="font-weight-bold mr-2">Số điện thoại:</span> <?php echo $agency['agency_contact']; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="card py-0" style="border: none;">
                <div class="card-body">
                    <div class="pb-3">
                        <span class="font-weight-bold font-italic border-bottom border-dark">Người quản lý</span>
                    </div>
                    ...
                    ?>
                    <div class="py-2 pl-2">
                        <span class="font-weight-bold mr-2">Tên:</span><?php echo $manager['employee_name']; ?>
                    </div>
                    <div class="py-2 pl-2">
                        <span class="mr-2"><i class="fas fa-envelope"></i></span>
                    ...
                    <div class="py-2 pl-2 mb-3">
                        <span class="mr-2"><i class="fas fa-phone-alt"></i></span>
                        <span class="font-weight-bold mr-2">Số điện thoại:</span> <?php echo $manager['employee_contact']; ?>
                    </div>
            ...
            <div class="card pt-0" style="border: none;">
                <div class="card-body">
                    <div class="pb-3">
                        <span class="font-weight-bold font-italic border-bottom border-dark">Nhân viên</span>
                    </div>
                    ...
                    ?>
                    <div class="py-2 pl-2">
                        <span class="font-weight-bold mr-2">Tên:</span><?php echo $staff['employee_name']; ?>
                    </div>
                    <div class="py-2 pl-2">
                        <span class="mr-2"><i class="fas fa-envelope"></i></span>
                    ...
                    <div class="py-2 pl-2 mb-3">
                        <span class="mr-2"><i class="fas fa-phone-alt"></i></span>
                        <span class="font-weight-bold mr-2">Số điện thoại:</span> <?php echo $staff['employee_contact']; ?>
                    </div>
