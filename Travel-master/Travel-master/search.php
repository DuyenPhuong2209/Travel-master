<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $stmt = $pdo->prepare('SELECT * FROM packages WHERE location LIKE :search  LIKE :search AND package_status = :package_status');
...
<div class="jumbotron jumbotron-fluid package">
  <div class="container">
    <h1 class="display-4 text-primary font-weight-bold">Tìm kết quả:</h1>
    <p class="lead">
        <form action="search.php" method="post" class="input-group">
            ...
            <button class="btn btn-outline-success ml-2 p-2" type="submit" name="Search"><i class="fas fa-search"></i></button>
        </form>
    </p>
  </div>
</div>
...
?>
    <div class="row">
        <div class="col-sm-12">
            <h1 class="py-4 text-muted font-italic" style="margin-left: 4rem;">Tour tìm thấy: <?php echo $package_count; ?></h1>
        <?php
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div>
                                <p class="text-muted" >
                                    ...
                                    <a href="package.php?package_id=<?php echo $package['package_id']; ?>" class="btn btn-primary float-right" style="position: relative; top: -30px; font-size: .8rem;">Xem<span class=" ml-2"><i class="fas fa-angle-right"></i></span>
                                    </a>
                                </p>
                            </div>
                        </div>
