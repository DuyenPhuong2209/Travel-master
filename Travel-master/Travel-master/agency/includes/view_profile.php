...
<div class="container-fluid">
    ...
    ?>
        <div class="text-center font-italic pt-5">
            <div class="p-2">
                <span class="font-weight-bold mr-3">Tên đại lý:</span> <?php echo $agency['agency_name']; ?>
            </div>
            <hr>
            <div class="p-2">
                <span class="font-weight-bold mr-3">Tên chủ sở hữu:</span> <?php echo  $agency['owner_name']; ?>
            </div>
            <hr>
            <div class="p-2">
                <span class="font-weight-bold mr-3">Địa chỉ văn phòng:</span> <?php echo $agency['agency_address']; ?>
            </div>
            <hr>
            <div class="p-2">
                <span class="font-weight-bold mr-3">Số điện thoại:</span> <?php echo $agency['agency_contact']; ?>
            </div>
            <hr>
            <div class="p-2">
            ...
            <div class="p-2">
                <a href="profile.php?page=edit_profile&edit=<?php echo $agency['agency_id']; ?>" class="btn btn-primary">Chỉnh sửa thông tin</a>
            </div>
