...
<div class="container my-5">
  ...
  <div class="content-container my-5">
    ...
    <div class="input-container" id="input-container">
        <h1 class="mb-5 text-white" data-aos="fade-up">Welcome To Travel </h1>
        <div class="quote" data-aos="fade-right" data-aos-delay="600">
          <p class='text-muted'>"Phiêu lưu là cách học hỏi tuyệt vời nhất”</p>
         </div>
...
<?php
    ...
    $stmt->execute([':review_status' => 'Đã phê duyệt']);
    $top_agencies = [];
...
<div class="container mt-5">
    <h3 class="text-center text-white pt-5">Đại lý hàng đầu</h3>
    <div class="row">

    <?php
      if(empty($top_agencies)){
        echo '<h2 class="text-center pt-4 mx-auto">Không tìm thấy đại lý nào</h2>';
      }else{
