<?php
    ...
    $stmt->execute([':package_status' => 'Có sẵn']);
...
<div class="jumbotron jumbotron-fluid package">
  <div class="container">
    <h1 class="display-4 text-primary font-weight-bold">Tour</h1>
    <p class="lead">
...
<?php 
    if(empty($packages)){
        echo '<Không class="text-center pt-4">Không tìm thấy Tour nào</h1>';
    }else{
?>
    <div class="row">
        <div class="col-sm-12">
            ...
            <?php
                if($page_no == 1 || $page_no == ' '){
                    echo '<li class="page-item disabled">
                            <a class="page-link" href="packages.php?page_no='. $prev .'" aria-label="Trước">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>';
                }else{
                    echo '<li class="page-item">
                            <a class="page-link" href="packages.php?page_no='. $prev .'" aria-label="Sau">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>';
                }
